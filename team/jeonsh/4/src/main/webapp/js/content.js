function getContent(){ 
	flagship.ajax('../content/ajax/list.do', {
		method: 'GET',
		success: function(contents){
			...
			var dateObj;
			var listTag;
			$('#contentID').append("<ul data-role='listview' data-inset='true' id='contentList'></ul>");
		  for(var index in contents) {
		  	...
		  	listTag = $(
	  			...
	  			"</a>" +
	  			"</li>");
		  	$('#contentID ul').append(listTag);
		  	
//		  	$('#contentID ul').append(
//		  			"<li style='margin: 10px'>" + 
//		  			"<a href='#'style='border: 1px solid #ededed'>" +
//		  			"<img class='ui-li-thumb' style='min-height: 80px' src='http://tv03.search.naver.net/nhnsvc?quality=8&size=80x80&q=http://dbscthumb.phinf.naver.net/2765_000_1/20131013135007779_AUPS4Y8LD.jpg/45823.jpg?type=r128_1&wm=N#128x96'>" +
//		  			"<h4>" + contents[index].title + "</h4>" +
//		  			"<p>" + getDateString(dateObj) + "</p>" +
//		  			"</a>" +
//		  	"</li>");

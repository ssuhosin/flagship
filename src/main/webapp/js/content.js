//function contentClassListner() {
//	var elemArray = document.getElementsByClassName(id);
			...
			if(xhr.status == 200) {
				...
				if(jsonResult.resultStatus == 1) {
					...
					for(var j = 0; j < contents.length; j++){
						...
						//div1.setAttribute("id", "content" + j);
